					...
					<div class="demo-section k-header">
						<p>
							...
							<input type="file" name="fileName"  style="width:180px"  text="选择文件上传" /> <a
								href="<%=basePath %>excelModel/GpsInfo.xls" style="font-size:12px;color:#819f0;"
					 ...
					 <p>  	
						<input type="submit" name="submit"  style="width:80px"  onclick="$('#gpsimportForm').submit()" value="开始导入" />
					</p> 
