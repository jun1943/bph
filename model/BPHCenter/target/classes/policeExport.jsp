				...
				<div class="pane-content">
					...
					<div class="demo-section k-header">
						<p>
							...
							<input type="file" style="width:180px" name="fileName" text="选择文件上传" /> <a
					 ...
					 <p>  	
						<input type="submit" name="submit" style="width:80px" onClick="$('#policeimportForm').submit()" value="开始导入" />
					</p> 
