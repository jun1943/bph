...
<div id="template">
	<div class="fl set-hei48">
		选择查询范围： <select class="w176" id="searchType" placeholder="请选择查询范围">
			<option value="1">本级机构</option>
			<option value="2">本级机构与下级机构</option>
		</select>
	</div>
	<div class="fl ml30 set-hei48">
		<span class="fl">用户名: <input type="search" class="k-textbox" id="userName" name="userName" placeholder="等待输入..." /></span> 
	...
	<div class="fl set-hei48">
		...
		<button id="undo" class="ty-btn-add ty-btn-offset" onclick="addUser()"></button>
	</div>
