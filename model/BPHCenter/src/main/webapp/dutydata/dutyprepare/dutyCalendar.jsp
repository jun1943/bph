...
<meta
	...
	name='viewport' /> 
<link href='<%=basePath%>resources/calendar/images/dateStyle.css' media='all'
	rel='stylesheet' type='text/css' />
	
	<link href='<%=basePath%>resources/calendar/images/dutycalendar.css' media='all'
	rel='stylesheet' type='text/css' /> 
	...
	$(function() {
		...
		m_dutyCalendar_Org.code = $("#organPath").val();
		m_dutyCalendar_Org.path = $("#organCode").val();
		m_dutyCalendar_Org.name = $("#organName").val();

		m_year = $("#pageStart").val();
		m_month = $("#pageSize").val();
	...
	function creatHtml(arr) {
		...
		for ( var i = 0; i < 6; i++) {// 寰幆鏁扮粍锛岄噸缁刪tml
			...
			for ( var j = 0; j < 7; j++) {
				...
				tdHtml += '   class="dateBoxMainDateTD"><div class="dateBoxMainDateTDLib">'
						+ arr[i][j]["d"]
	...
	<div class="dateBox">
    	...
    	<div class="dateBoxMain">
    		<div class="dateBoxMainTItle">
        		<div class="dateBoxMainTItleTxt">报备月程表
        		
		<input id="token" type="hidden" value="${query.sort}"/> 
		<input  id="organId" type="hidden" value="${organ.id}">
		<input  id="organPath" type="hidden" value="${organ.path}">
		<input  id="organCode" type="hidden" value="${organ.code}"> 
		<input  id="organName" type="hidden" value="${organ.shortName}"> 
        ...
        <input type="hidden" id="pageStart" name="pageStart" value="${query.pageNo}">
	            ...
	            <div class="dateBoxMainTItleBox">
	            	<div class="dateBoxMainTItleBoxMain">
	                	<ul>
	                    	<li><img src="<%=basePath %>resources/calendar/images/dateLast.png" onclick="getDateClick('last')" /></li>
	                        <li><span class="lispan" id="sp_years"></span>年</li>
	                        <li><span class="lispan" id="sp_month"></span>月</li>
	                        <li><img  class="liimg" src="<%=basePath %>resources/calendar/images/dateNext.png" onclick="getDateClick('next')" /></li>
                    	</ul>
	                </div>
	            </div>	
	            <!-- 清楚本月报备数据以及清空剪切板 -->
	            <div class="dateBoxMainTItleTxt">
	            	<div class="dateBoxMainTItleTxtDIv">
	                    <a href="javascript:void(0);" onclick="clearAlldutyData()"><img src="<%=basePath %>resources/calendar/images/canelpast.png" alt="清除当月所有报备数据" title="清除当月所有报备数据" /></a>
	                    <a href="javascript:void(0);" onclick="clearClipbord()"><img src="<%=basePath %>resources/calendar/images/past.png" alt="取消剪贴板数据" title="取消剪贴板数据"  /></a>
	                </div>
	            </div>
        	</div>
        	<!-- 日历主界面 -->
