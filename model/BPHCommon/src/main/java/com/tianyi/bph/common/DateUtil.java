 ...
 * <br>本类所有方法均为静态方法，通过类名直接调用。
 * <br>常量介绍：
 *         <br>DateUtil.MONDAY    星期一
 *         <br>DateUtil.TUESDAY   星期二
 *         <br>DateUtil.WEDNESDAY 星期三
 *         <br>DateUtil.THURSDAY  星期四
 *         <br>DateUtil.FRIDAY    星期五
 *         <br>DateUtil.SATURDAY  星期六
 *         <br>DateUtil.SUNDAY    星期天
 * 
...
public final class DateUtil {
	 ...
	 * @param patternOut 希望生成的日期格式
	 * @return 日期格式字符串
	 * @throws ParseException 如果传入的date字符串不能转换成java.util.Date对象，则抛出该异常;
	 */
	 ...
	 * 将字符串转换成日期对象
	 * @param str 日期字符串
	 * @param pattern 该字符串的格式
	 * @return 日期格式字符串
	 * @throws ParseException 如果传入的str字符串不能转换成java.util.Date对象，则抛出该异常
	 */
	 ...
	 * 该间隔天数为自然天。
	 * 例：
	 *     2013-06-01 23:59:59和2013-06-02 00:00:00的间隔天数为1天。（实际间隔时间是1秒）
	 * @param min 较小的日期对象
	 * @param max 较大的日期对象
	 ...
	 * 该间隔月数为自然月。
	 * 例：
	 *     2013-06-30和2013-07-01的间隔月数为1月。（实际间隔时间是1天）
	 * @param min 较小的日期对象
	 * @param max 较大的日期对象
	 ...
	 * 该间隔年数为自然年。
	 * 例：
	 *     2012-12-31和2013-01-01的间隔年数为1年。（实际间隔时间是1天）
	 * @param min 较小的日期对象
	 * @param max 较大的日期对象
